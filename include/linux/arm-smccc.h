...
#define ARM_SMCCC_KVM_FUNC_PVM_DMA_SHARE	50
...
#define KVM_PVM_DMA_SHARE_GRANT			0
#define KVM_PVM_DMA_SHARE_ACCEPT		1
#define KVM_PVM_DMA_SHARE_QUERY			2

#define ARM_SMCCC_VENDOR_HYP_KVM_PVM_DMA_SHARE_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_PVM_DMA_SHARE)
